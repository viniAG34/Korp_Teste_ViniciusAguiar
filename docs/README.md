...
| [`RELATORIO-IMPLEMENTACAO-SDD-02.md`](RELATORIO-IMPLEMENTACAO-SDD-02.md) | Evidências e recomendação do Gate C da modelagem e persistência | Em revisão | SDD-02 e plano de implementação | 2026-08-20 |
...
| 02 | [`SDD-02-MODELAGEM-DE-DADOS.md`](SDD-02-MODELAGEM-DE-DADOS.md) | Entidades, invariantes, bancos, índices e auditoria | Implementado | SDD-01 | Gate C em revisão |
| 03 | [`SDD-03-CONTRATOS-HTTP-E-EVENTOS.md`](SDD-03-CONTRATOS-HTTP-E-EVENTOS.md) | APIs e contratos de integração | Aprovado | SDD-01, SDD-02 | Gate A aprovado |
