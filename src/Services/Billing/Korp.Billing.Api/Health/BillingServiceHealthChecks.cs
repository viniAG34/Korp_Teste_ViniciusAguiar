...
namespace Korp.Billing.Api.Health;

public static class BillingServiceHealthChecks
{
    public static IHealthChecksBuilder AddBillingHealthChecks(this IServiceCollection services) =>
...
internal sealed class DatabaseHealthCheck(IDbContextFactory<BillingDbContext> factory) : IHealthCheck
{
