...
O SDD-07 possui Gate A e Gate B aprovados. O Marco 1 implementou a topologia RabbitMQ e produziu evidência real para TST-DST-001 e TST-DST-002. O Marco 2 implementou reserva concorrente, lease, publisher confirms, `mandatory`, backoff e confirmação local, com evidência parcial para TST-DST-004 e TST-DST-005. As provas usam PostgreSQL e RabbitMQ reais; a regressão do segundo ponto-chave aprovou 163 testes sem falhas. Crash dirigido, consumers, retry operacional, health e fluxo distribuído permanecem nos marcos seguintes.
