...
public sealed class MessagingMetricsTests
{
    ...
    public void TstDst023PublishesApprovedLowCardinalityMetrics()
    {
        ...
        using var listener = new MeterListener
        {
            ...
            {
                if (instrument.Meter.Name != "Korp.Billing.Messaging") return;
        ...
        metrics.RecordConsumed("StockDeductionCompleted", "Processed", TimeSpan.FromMilliseconds(20));
        ...
        Assert.Contains("service=billing", tags);
