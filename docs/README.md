...
| [`RELATORIO-IMPLEMENTACAO-SDD-06.md`](RELATORIO-IMPLEMENTACAO-SDD-06.md) | Notas, itens, emissão durável, segurança e evidências | Em revisão | SDD-06 e plano de implementação | Aguardando aprovação do Gate C |
...
| 06 | [`SDD-06-BILLING-SERVICE.md`](SDD-06-BILLING-SERVICE.md) | Notas, itens, estados e impressão | Implementado | SDD-02, SDD-03, SDD-04, SDD-05 | Gate C em revisão |
